...
| 13.5.3 STATE_PATCH | Patch roundtrip and bounds checks | `tests/coverage_boost.rs::register_and_use_base_snapshot_reference`, `tests/coverage_boost.rs::map_key_change_does_not_use_state_patch`, `src/lib.rs::tests::session_decoder_reconstructs_state_patch` |
...
| 16.5 session decoder | Public session decoder API and reset lifecycle | `src/lib.rs::tests::session_decoder_reconstructs_state_patch`, `src/lib.rs::tests::session_decoder_reset_rejects_orphan_patch`, `src/lib.rs::tests::session_encoder_and_decoder_do_not_share_state` |
