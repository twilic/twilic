...
echo "[interop] Emitting R server frames..."
TWILIC_R_ROOT="${ROOT_DIR}" Rscript "${ROOT_DIR}/inst/interop/emit-rust-client-fixtures.R" > "${FIXTURES_FILE}"
...
echo "[interop] OK: R server -> Rust client smoke test passed"
