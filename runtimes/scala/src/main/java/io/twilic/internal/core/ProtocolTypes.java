...
final class SessionOptions {
  int maxBaseSnapshots = 8;
  boolean enableStatePatch = true;
  boolean enableTemplateBatch = true;
  boolean enableTrainedDictionary = true;
  UnknownReferencePolicy unknownReferencePolicy = UnknownReferencePolicy.FAIL_FAST;
}
