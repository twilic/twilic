...
This file maps `twilic/SPEC.md` requirements to PHPUnit tests in `runtimes/php`.
...
| Rust client validates PHP fixture values | `InteropFixturesTest::testRustDecodesPhpFramesWithSameValues`, `scripts/check-rust-client-interop.sh` |
| Rust server → PHP client (smoke) | `InteropFixturesTest::testDecodeRustServerFrames`, `scripts/check-php-client-interop.sh` |
