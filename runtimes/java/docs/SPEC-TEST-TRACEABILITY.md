...
This file maps `twilic/SPEC.md` requirements to Java tests in `runtimes/java`.
...
| Rust client validates Go fixture values | `InteropFixturesTest.rustDecodesGoFramesWithSameValues` |
